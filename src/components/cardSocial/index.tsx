          ...
          {FollowsArray.map((social) => {
            ...
            return (
              ...
              >
                ...
                <Image className='w-full h-full object-cover rounded-t-lg' src={social.img} alt='LogoDev' width={1176} height={827}></Image>
                </div>
                <div className='flex justify-between relative z-2'>
                    <div className='w-[5rem] h-[5rem] bg-blac  rounded-full shadow-md'>
                        <Image className='w-full h-full rounded-full object-cover' src={social.logo} alt='LogoDev' width={1176} height={827}></Image>
                    </div>
                </div>
