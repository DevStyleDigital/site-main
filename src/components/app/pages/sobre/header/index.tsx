...
const HeaderAnimationAbout = () => {
  ...
  return (
    <HeroText.Root className="header_about">
      ...
      >
        <div className="w-[15rem] h-[15rem] rounded-full sombra-1 absolute bottom-[8rem] left-[35%] z-2 max-md:top-[10rem] max-md:right-0" />
        <div className="w-[15rem] h-[15rem] rounded-full sombra-2 absolute bottom-[8rem] right-[20%] z-2 max-md:top-[10rem] max-md:left-0" />
        <div className="w-[5rem] h-[2rem] shadow-md absolute bottom-[13rem] rotate-45 left-[10rem] bg-[#bee1f9] z-2 max-md:left-[2rem] max-md:top-[15rem] max-lg:opacity-[60%]" />
