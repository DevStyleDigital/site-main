...
const HeaderAnimationProjects = () => {
  ...
  return (
    <HeroText.Root className="header_projects">
      <motion.div
        ...
        animate="visible"
      >
      <HeroText.Img className='right-[50%]  w-[50rem] h-[48rem]  translate-x-[50%] top-[20%] max-lg:text-[3rem] max-md:w-[30rem] max-xl:w-full max-sm:w-screen max-md:h-[35rem] max-xl:h-screen max-md:translate-y-[20%] max-[920px]:translate-y-[10%]'>
      ...
      >
        <div className="w-[15rem] h-[15rem] rounded-full sombra-8 absolute bottom-[8rem] left-[25%] z-2 max-md:top-[10rem] max-md:right-0"></div>
        <div className="w-[15rem] h-[15rem] rounded-full sombra-9 absolute bottom-[8rem] right-[20%] z-2 max-md:top-[10rem] max-md:left-0"></div>
        <div className="w-[15rem] h-[15rem] rounded-full sombra-10 absolute top-[20rem] right-[10%] z-2 max-md:top-[10rem] max-md:left-0"></div>
        <div className="w-[5rem] h-[2rem] shadow-md absolute bottom-[13rem] rotate-45 left-[10rem] bg-[#D7E1EB] z-2 max-md:left-[2rem] max-md:top-[15rem] max-lg:opacity-[60%]"></div>
...
export default HeaderAnimationProjects
