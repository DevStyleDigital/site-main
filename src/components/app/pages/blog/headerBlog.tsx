...
const HeaderBlog = ({ post, colors }: { post: any; colors: string }) => {
  ...
  return (
    <motion.section
      className={
        'w-full h-fit flex pt-[120px] pb-[60px] justify-center min-h-[90vh]  relative px-5'
      }
    >
      <div
        className={'w-full h-1/3 absolute max-sm:h-1/5 top-0 left-0'}
      ...
      <div className="w-full relative z-[1] flex py-10 justify-center">
        <div className="max-w-[1400px] w-full flex flex-col gap-6">
          <div className="w-full flex gap-10 items-center">
            <div className="border border-secondary_black-950 rounded-full font-medium px-3 py-1 text-secondary_black-950">
              {post.type}
            </div>
            <span className="text-secondary_black-950 font-medium">
          ...
          <div className="w-full flex justify-between items-center max-md:flex-col max-md:gap-5">
            <div className="flex gap-5 items-center">
              ...
              <div className="flex flex-col">
                <span className="font-medium text-lg text-black/90 max-sm:text-sm">
                  {post.autor}
                </span>
                <span className="font-medium text-sm text-[#555555]/70 max-sm:text-sm">
                  {person.carer}
                </span>
              </div>
            </div>
          ...
          <span className="w-full h-[2px] bg-[#555555]/20 rounded-full" />
