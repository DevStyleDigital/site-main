...
const ServicesSection = () => {
    return (
        <section id="service" className="w-full h-fit flex justify-center py-[4rem] px-[3rem] bg-secondary_black-950 max-md:px-[1rem] z-50">
                ...
                <HeaderSection.Root>
                    <div className="flex items-center gap-[2rem] max-md:gap-[1rem]">
                        ...
                        <div className="flex flex-col gap-[.5rem]">
                            <HeaderSection.Path>
                                <span className="font-extrabold text-[1rem] tracking-widest text-[#FEC90C] max-lg:text-[.8rem]">//</span> 01 . Serviços
                            </HeaderSection.Path>
                    ...
                    <div className="max-sm:hidden">
                        <Button fill light>Nossos Serviços <IconProx/></Button>
                    </div>
                </HeaderSection.Root>
                <ServiceAnimation />
            </div>
