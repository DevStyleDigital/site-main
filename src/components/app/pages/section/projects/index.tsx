...
const Projects = () => {
    return (
        <section id="projects" className="w-full h-fit min-h-[80vh] flex justify-center py-[4rem] bg-secondary_black-950">
                ...
                <HeaderSection.Root>
                    <div className="flex items-center gap-[2rem] max-md:gap-[1rem]">
                        ...
                        <div className="flex flex-col gap-[.5rem]">
                            <HeaderSection.Path>
                                <span className="font-extrabold text-[1rem] tracking-widest text-[#FEC90C]">//</span> 05 . Projetos
                            </HeaderSection.Path>
                    ...
                    <div className="max-sm:hidden">
                        <Button fill light>Veja mais <IconProx/></Button>
                    </div>
                </HeaderSection.Root>
                <ProjectCLient />
