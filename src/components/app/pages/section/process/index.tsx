...
const Process = () => {
    return (
        <section id="process" className="w-full h-fit flex justify-center pb-[4rem] bg-background_process  max-lg:min-h-[110vh]">
                ...
                <HeaderSection.Root>
                            <div className="flex flex-col items-center gap-[1rem] py-[2rem]">
                                ...
                                <HeaderSection.Path dark>
                                    <span className="font-extrabold text-[1rem] tracking-widest text-[#5956E8]">//</span> 03 . Processos
                                </HeaderSection.Path>
