...
const Process = () => {
  return (
    ...
    >
      <div className="w-[60%] max-[380px]:min-h-[100vh] h-auto bg-process flex flex-col items-center p-[4rem] rounded-md  max-2xl:w-[70%] max-xl:w-[80%] max-lg:w-[90%] max-sm:w-[95%] max-sm:p-[1rem] max-[320px]:p-[.5rem] max-[320px]:w-full">
        <HeaderSection.Root>
