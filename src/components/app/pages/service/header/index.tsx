...
const HeaderAnimationService = () => {
  ...
  return (
    <HeroText.Root className="header_service">
      <motion.div
      ...
      >
        <div className="w-[15rem] h-[15rem] rounded-full sombra-3 absolute bottom-[8rem] left-[25%] z-2 max-md:top-[10rem] max-md:right-0"></div>
        <div className="w-[15rem] h-[15rem] rounded-full sombra-4 absolute bottom-[8rem] right-[20%] z-2 max-md:top-[10rem] max-md:left-0"></div>
        <div className="w-[15rem] h-[15rem] rounded-full sombra-5 absolute top-[20rem] right-[10%] z-2 max-md:top-[10rem] max-md:left-0"></div>
...
export default HeaderAnimationService
