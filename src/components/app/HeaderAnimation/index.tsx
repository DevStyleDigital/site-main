        ...
        <HeroText.Root className="header_home">
            <HeroText.Img>
                <div className="w-full h-full rounded-full relative">
                    <Image src={Fundo} className="FundoImg" alt="fundoimg" width={450} height={519}></Image>
                    <motion.div className="w-full h-full relative preserve" style={{rotateX:a, rotateY:b}}>
                        <motion.div 
                        ...
                        <motion.div 
                            ...
                            <Image src={Microfone} alt="Microfone" width={211} height={187}></Image>
                        </motion.div>
                        <motion.div 
                        ...
                        <Image src={Triangulo} className="triangulo" alt="triangulo" width={30} height={33}></Image>
                    </motion.div>
                </div>
            </HeroText.Img>
            <motion.div 
            ...
            >   
                <HeroText.Rota>
                    <span className="font-extrabold text-[1rem] tracking-widest text-[#FEC90C]">//</span> INÍCIO
                </HeroText.Rota>
                <HeroText.Title>
                    Construindo marcas,<br /> uma história de <span className="text-[#5956E8]">sucesso</span> por vez.
                </HeroText.Title>
                <HeroText.SubTitle>
                    Crie uma marca que ressoe: podemos ajudá-lo a definir e comunicar sua mensagem exclusiva.
                </HeroText.SubTitle>
                <HeroText.Buttons>
            ...
            <motion.div className="w-[100vw] h-[90vh] absolute select-none"  style={{rotateX:a, rotateY:b}}>
