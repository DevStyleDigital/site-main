        ...
        return (
          ...
          >
            <div className="w-full min-h-[250px] max-sm:h-[250px] overflow-hidden rounded-xl bg-black">
              <Image
                src={`${blogPost.banner.url}?${Date.now()}`}
                alt="banner"
                width={2800}
                height={1200}
            ...
            <div className="w-full h-full justify-between flex flex-col px-2 gap-4 max-sm:gap-8">
              <div className="flex flex-col gap-2">
                ...
                <h2 className="font-bold text-xl max-w-[90%] break-words text-secondary_black-950">
                  {blogPost.title}
                </h2>
              </div>
                ...
                <div className="w-full flex justify-between items-center">
                  <div className="flex gap-2">
                    <div className="w-10 h-10 max-sm:w-6 max-sm:h-6 bg-black rounded-full overflow-hidden">
                      <Image
                        src={`${blogPost.bannerAutor.url}?${Date.now()}`}
                        width={200}
                        height={200}
                        alt="imageAutor"
                        className="w-full h-full object-cover"
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="font-medium text-black/40 text-xs">
