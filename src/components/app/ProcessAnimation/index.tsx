...
const ProcessAnimation = () => {
  ...
  return (
    ...
    >
      <motion.div
        variants={setTimes(1.5)}
        className="grid h-full value-cols justify-items-center items-center gap-[1rem] w-full"
      >
      ...
      <motion.div
        variants={setTimes(3)}
        className="grid h-full value-cols justify-items-center items-center gap-[1rem]"
      >
