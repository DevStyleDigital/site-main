        ...
        <div className='flex flex-col gap-2'>
            ...
            <div className="flex gap-2 mt-2 items-center">
                ...
                <div className="flex flex-col">
                    <span className="text-sm truncate max-w-[200px]">Foi debitado R$100,00 da sua con...</span>
            ...
            <div className="flex mt-2 gap-2 items-center">
                ...
                <div className="flex flex-col">
                    <span className="text-sm truncate max-w-[200px]">Ocorreu no pagamento automatic...</span>
