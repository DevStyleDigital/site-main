...
export const ProcessArray: iProcess[] = [
  ...
  },
  {
    ...
    label:
      'Com as estrategias elaboradas iremos começar com o desenvolvimento do layout com o Designer',
    icon: Layout,
  },
  {
    id: 3,
    title: '3. Aprovação',
    label:
      'Finalizando o layout passaremos para o cliente para ajustes e aprovação e com isso continuaremos com os processos',
    icon: Love,
  },
  {
    id: 4,
    ...
    label:
      'Após a aprovação do cliente partiremos para o desenvolvimento da solução trazendo elementos recomendados para o ambiente',
  ...
  },
  {
    ...
    label:
      'Entregando o projeto iremos fazer o tratamento do Google de tagueamento para manter colocar a página nos buscadores',
    icon: MegaFone,
  },
  {
    id: 6,
    ...
    label:
      'Partindo para a última etapa sendo a apresentação e instrução para o uso do sistema para o cliente',
    icon: Custo,
  },
];
