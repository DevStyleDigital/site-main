...
const Post = async ({ params }: { params: { id: string } }) => {
    ...
    const colors = ['linear-gradient(111.23deg, #F9F6DA 9.95%, #E2D5FF 85.17%)', 'linear-gradient(140deg, #CFD4FF 0%, #FFFFFD 100%)', 'linear-gradient(111.23deg, #E9F7FF 9.95%, #FFDBD5 85.17%)', 'linear-gradient(140deg, #CFD4FF 0%, #FFFFFD 100%)']
